...
class TestHealthEndpoints:
    ...
    def test_ncbi_health_check(self, mock_retriever_class, client):
        ...
        mock_retriever.fetch_paper_metadata.return_value = {"title": "Test Title", "abstract": "Test abstract"}
...
class TestSystemEndpoints:
    ...
    def test_system_status(self, mock_gemini, mock_metrics, mock_config, mock_health, client):
        """Test system status endpoint."""
        mock_health.return_value = {"status": "healthy", "timestamp": "2023-01-01", "version": "1.0.0"}
...
class TestBugSigDBAnalysisEndpoints:
    ...
    def test_analyze_paper_success(self, mock_analyze, client):
        ...
        mock_result = {
            "pmid": "12345678",
            "title": "Test Paper",
            "fields": {"host_species": {"status": "PRESENT", "value": "Human", "confidence": 0.95}},
        }
...
class TestQAEndpoint:
    ...
    def test_ask_question_success(self, mock_qa, client):
        ...
        mock_qa.chat = AsyncMock(return_value={"text": "This is a test answer", "confidence": 0.9})

        response = client.post("/api/v1/qa", json={"question": "What is the microbiome?"})
        assert response.status_code == 200
        data = response.json()
...
class TestMetricsEndpoint:
    ...
    def test_get_metrics(self, mock_cache_class, mock_perf_logger, client):
        ...
        mock_cache.get_cache_stats.return_value = {"total_requests": 100, "cache_hits": 80}
