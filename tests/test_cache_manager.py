...
class TestAnalysisCache:
    ...
    def test_store_analysis_result(self, cache_manager):
        ...
        result = cache_manager.store_analysis_result(pmid, analysis_data, metadata, source="test", confidence=0.95)
    ...
    def test_get_analysis_result(self, cache_manager):
        ...
        # Store first
        cache_manager.store_analysis_result(pmid, analysis_data, metadata, source="test", confidence=0.95)
...
class TestMetadataCache:
    ...
    def test_store_metadata(self, cache_manager):
        ...
        pmid = "12345678"
        metadata = {"title": "Test Paper", "authors": ["Author1", "Author2"], "journal": "Test Journal"}
...
class TestFulltextCache:
    ...
    def test_store_fulltext(self, cache_manager):
        ...
        pmid = "12345678"
        fulltext = "This is the full text of the paper. It contains important information."
...
class TestCacheStats:
    ...
    def test_get_cache_stats(self, cache_manager):
        ...
        # Store some data
        cache_manager.store_analysis_result("12345678", {"test": "data"}, {"title": "Test"}, confidence=0.9)
...
class TestCacheOperations:
    ...
    def test_clear_cache(self, cache_manager):
        ...
        # Store some data
        cache_manager.store_analysis_result("12345678", {"test": "data"}, {"title": "Test"})
...
class TestAsyncOperations:
    ...
    async def test_store_analysis_result_async(self, cache_manager):
        ...
        result = await cache_manager.store_analysis_result_async(pmid, analysis_data, metadata)
        assert result is True
