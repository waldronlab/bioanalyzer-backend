...
class TestFormatPredictionOutput:
    ...
    def test_format_prediction_output_basic(self):
        ...
        result = format_prediction_output(
            pmid="12345678", has_signature=True, signature_probability=0.95, sequencing_type="16S rRNA"
        )
    ...
    def test_format_prediction_output_without_metadata(self):
        ...
        result = format_prediction_output(
            pmid="12345678", has_signature=True, signature_probability=0.8, sequencing_type="16S rRNA"
        )
