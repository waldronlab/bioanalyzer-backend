...
class TestPerformanceLogger:
    ...
    def test_log_pmid_query_start(self):
        ...
        logger.log_pmid_query_start("12345678", user_agent="Test", ip_address="127.0.0.1")
    ...
    def test_log_pmid_query_end_failure(self):
        ...
        logger = PerformanceLogger()
        logger.log_pmid_query_end("12345678", duration=2.0, success=False, error="Test error")
    ...
    def test_log_api_call_success(self):
        ...
        logger = PerformanceLogger()
        logger.log_api_call("pubmed", "fetch_metadata", "12345678", duration=0.5, success=True)

    def test_log_api_call_failure(self):
        """Test logging failed API call."""
        logger = PerformanceLogger()
        logger.log_api_call("gemini", "analyze", "12345678", duration=1.0, success=False, error="Timeout")
    ...
    def test_log_cache_operation_failure(self):
        ...
        logger = PerformanceLogger()
        logger.log_cache_operation("GET", "12345678", "metadata", duration=0.02, success=False)
    ...
    def test_log_analysis_step_with_details(self):
        ...
        logger.log_analysis_step("12345678", "field_extraction", duration=0.5, details=details)

    def test_log_performance_metrics(self):
        """Test logging performance metrics."""
        logger = PerformanceLogger()
        metrics = {"total_time": 2.5, "api_calls": 3, "cache_hits": 2, "cache_misses": 1}
...
class TestPerformanceLoggerIntegration:
    ...
    def test_full_query_logging_flow(self):
        ...
        # Log API calls
        logger.log_api_call("pubmed", "fetch_metadata", "12345678", duration=0.3, success=True)
        ...
        # Log metrics
        metrics = {"total_time": 2.0, "api_calls": 2, "cache_operations": 1, "analysis_steps": 2}
        logger.log_performance_metrics("12345678", metrics)
    ...
    def test_error_logging_flow(self):
        ...
        # Log failed API call
        logger.log_api_call("pubmed", "fetch_metadata", "12345678", duration=5.0, success=False, error="Timeout")
        ...
        logger.log_pmid_query_end("12345678", duration=5.0, success=False, error="Timeout")
