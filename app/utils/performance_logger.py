...
class PerformanceLogger:
    ...
    def log_cache_operation(
        self, operation: str, pmid: str, cache_type: str, duration: float, success: bool
    ):
    ...
    def log_analysis_step(
        self, pmid: str, step: str, duration: float, details: Dict[str, Any] = None
    ):
