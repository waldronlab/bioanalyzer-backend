...
class PerformanceLogger:
    ...
    def __init__(self):
        ...
        perf_handler = RotatingFileHandler(
            "logs/performance.log", maxBytes=10 * 1024 * 1024, backupCount=5, encoding="utf-8"  # 10MB
        )
    ...
    def log_pmid_query_end(self, pmid: str, duration: float, success: bool, cached: bool = False, error: str = None):
    ...
    def log_api_call(self, service: str, operation: str, pmid: str, duration: float, success: bool, error: str = None):
    ...
    def log_cache_operation(self, operation: str, pmid: str, cache_type: str, duration: float, success: bool):
    ...
    def log_analysis_step(self, pmid: str, step: str, duration: float, details: Dict[str, Any] = None):
    ...
    async def async_wrapper(*args, **kwargs):
        ...
        try:
            ...
            perf_logger.log_analysis_step(
                pmid or "Unknown", f"{func.__module__}.{func.__name__}", duration, {"success": True}
            )
            ...
            # Log error
            perf_logger = PerformanceLogger()
            perf_logger.log_error(pmid or "Unknown", e, f"{func.__module__}.{func.__name__}")
